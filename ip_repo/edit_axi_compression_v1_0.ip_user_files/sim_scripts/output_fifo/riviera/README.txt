...
#
# Generated by export_simulation on Fri Mar 31 09:04:51 -0400 2017
#
################################################################################
...
switch to the './output_fifo.sh' script.

./output_fifo.sh -reset_run
...
./output_fifo.sh -noclean_files

For more information on the script, please type './output_fifo.sh -help'.
