...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../axi_compression_1.0/src/output_fifo/sim/output_fifo.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.output_fifo xil_defaultlib.glbl -o output_fifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./output_fifo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key output_fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc output_fifo_simv.daidir)
