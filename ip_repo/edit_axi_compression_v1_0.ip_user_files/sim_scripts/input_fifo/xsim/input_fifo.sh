...
#
# Generated by Vivado on Fri Mar 31 09:03:11 -0400 2017
# IP Build 1755317 on Mon Jan 23 20:30:07 MST 2017 
#
# usage: input_fifo.sh [-help]
# usage: input_fifo.sh [-lib_map_path]
# usage: input_fifo.sh [-noclean_files]
# usage: input_fifo.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "input_fifo.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot input_fifo xil_defaultlib.input_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim input_fifo -key {Behavioral:sim_1:Functional:input_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./input_fifo.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb input_fifo.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./input_fifo.sh -help\" for more information)\n"
    exit 1
  fi
