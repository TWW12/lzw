...
#
# Generated by export_simulation on Fri Mar 31 09:03:11 -0400 2017
#
################################################################################
...
switch to the './input_fifo.sh' script.

./input_fifo.sh -reset_run
...
./input_fifo.sh -noclean_files

For more information on the script, please type './input_fifo.sh -help'.
