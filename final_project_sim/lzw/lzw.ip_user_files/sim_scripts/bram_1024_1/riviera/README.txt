...
#
# Generated by export_simulation on Thu Apr 13 13:49:09 -0400 2017
#
################################################################################
...
switch to the './bram_1024_1.sh' script.

./bram_1024_1.sh -reset_run
...
./bram_1024_1.sh -noclean_files

For more information on the script, please type './bram_1024_1.sh -help'.
