...
HD_PWD='X:/final_project_sim/lzw/lzw.runs/bram_1024_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_1024_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_1024_2.tcl
