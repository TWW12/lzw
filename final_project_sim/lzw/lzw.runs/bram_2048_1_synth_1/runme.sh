...
HD_PWD='X:/final_project_sim/lzw/lzw.runs/bram_2048_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_2048_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_2048_1.tcl
