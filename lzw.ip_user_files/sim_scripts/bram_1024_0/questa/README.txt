...
#
# Generated by export_simulation on Sat Apr 15 19:25:48 -0400 2017
#
################################################################################
...
switch to the './bram_1024_0.sh' script.

./bram_1024_0.sh -reset_run
...
./bram_1024_0.sh -noclean_files

For more information on the script, please type './bram_1024_0.sh -help'.
