...
HD_PWD='X:/final_project_sim/lzw/lzw.runs/bram_4096_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_4096.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_4096.tcl
